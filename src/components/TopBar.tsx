...
export default function TopBar() {
  return (
    <div className="bg-bg-secondary border-b border-divider">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-2 text-sm text-text-secondary">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-accent-purple">
